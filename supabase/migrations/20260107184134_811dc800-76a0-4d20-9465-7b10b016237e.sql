...
ALTER TABLE order_line_items DROP CONSTRAINT IF EXISTS fk_order_line_items_selected_bottle;
...
ALTER TABLE order_line_items DROP CONSTRAINT IF EXISTS fk_order_line_items_selected_cap;
ALTER TABLE order_line_items 
...
ALTER TABLE order_line_items DROP CONSTRAINT IF EXISTS fk_order_line_items_selected_label;
ALTER TABLE order_line_items 
