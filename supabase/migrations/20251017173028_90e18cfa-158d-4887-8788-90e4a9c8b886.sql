...
-- Explicitly qualify raw_material_id references to avoid conflict with RETURNS TABLE variable
...
BEGIN
  ...
  inventory_status AS (
    ...
    LEFT JOIN inventory_lots il ON il.raw_material_id = rm.id AND il.quantity > 0
