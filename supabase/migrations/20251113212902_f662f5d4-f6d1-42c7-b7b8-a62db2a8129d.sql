-- Fix check_packaging_availability function to remove incorrect size filtering
-- The function was trying to match bottle count (60ct, 90ct) against volume (cc) which never matched
