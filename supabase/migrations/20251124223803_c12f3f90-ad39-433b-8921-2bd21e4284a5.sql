...
INSERT INTO customer_inquiries (id, customer_id, customer_name, customer_email, customer_phone, company_name, inquiry_type, subject, message, urgency, status, created_at)
VALUES (
...
INSERT INTO customer_inquiries (id, customer_name, customer_email, customer_phone, company_name, inquiry_type, subject, message, urgency, status, created_at)
VALUES (
...
INSERT INTO inquiry_messages (inquiry_id, message, sender_type, sender_name, sender_email, is_internal_note, created_at) VALUES
...
('11111111-1111-1111-1111-111111111111', 'Quote sent via email. Confirmed raw materials are in stock. This should be a smooth production run.', 'staff', 'Production Team', null, true, NOW() - INTERVAL '1 day' + INTERVAL '30 minutes');
...
('22222222-2222-2222-2222-222222222222', 'For R&D test batches, we can do as low as 1,000 units. This gives you enough for internal testing and focus groups without a huge commitment. Let me prepare a proposal.', 'staff', 'R&D Team', null, false, NOW() - INTERVAL '1 day');
...
('33333333-3333-3333-3333-333333333333', 'Simple unit conversion error. Updated invoice template to prevent this in future.', 'staff', 'Billing Team', null, true, NOW() - INTERVAL '6 days');
...
('44444444-4444-4444-4444-444444444444', 'Batch #ELD-2024-0892. I''ve attached photos in a separate email showing the affected gummies. The discoloration appears darker purple/brown on about 500 units.', 'customer', 'David Park', 'david@lunakai.com', false, NOW() - INTERVAL '20 hours');
...
('55555555-5555-5555-5555-555555555555', 'New prospect inquiry - wholesale partnership. 15 retail locations. Assign to business development team for initial call.', 'staff', 'Admin', null, true, NOW() - INTERVAL '5 days' + INTERVAL '1 hour');
...
('66666666-6666-6666-6666-666666666666', 'Perfect! Approved for the rush fee. We''ll arrange pickup Thursday evening. You''re a lifesaver!', 'customer', 'Robert Thompson', 'robert@gotgummies.com', false, NOW() - INTERVAL '3 hours');