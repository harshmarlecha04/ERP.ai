-- Update get_material_requirements_by_date_range to correctly calculate on-order quantities
-- by joining through purchase_order_items instead of using purchase_orders.ingredient_name
