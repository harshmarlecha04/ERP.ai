...
CREATE INDEX IF NOT EXISTS idx_formulas_customer_id ON formulas(customer_id);
...
CREATE INDEX IF NOT EXISTS idx_packaging_item_customer_id ON packaging_item(customer_id);
...
CREATE INDEX IF NOT EXISTS idx_label_inventory_customer_id ON label_inventory(customer_id);
