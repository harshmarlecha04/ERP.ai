...
ON public.formulas
FOR SELECT
USING ((NOT is_deleted) AND validate_formula_access_secure(auth.uid(), id, 'view'::text)); EXCEPTION WHEN wrong_object_type OR undefined_object OR undefined_table THEN NULL; END $pol$;
