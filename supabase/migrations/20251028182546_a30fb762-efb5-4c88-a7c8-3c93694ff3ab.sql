...
ALTER TABLE inventory_update_session_items DROP CONSTRAINT IF EXISTS inventory_update_session_items_movement_id_fkey;
ALTER TABLE inventory_update_session_items
...
ALTER TABLE inventory_update_session_items DROP CONSTRAINT IF EXISTS inventory_update_session_items_label_inventory_id_fkey;
ALTER TABLE inventory_update_session_items
