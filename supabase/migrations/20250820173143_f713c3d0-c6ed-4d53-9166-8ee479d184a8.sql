-- Fix the database function to use the correct column name 'uom' instead of 'unit_of_measure'
...
BEGIN
  ...
  -- Insert raw material with idempotency key - FIXED: use 'uom' instead of 'unit_of_measure'
