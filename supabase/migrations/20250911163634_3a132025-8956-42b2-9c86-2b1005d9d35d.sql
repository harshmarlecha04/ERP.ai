...
-- Drop the old function without parameters that's causing ambiguity
DROP FUNCTION IF EXISTS public.get_accessible_formulas();

-- Ensure we keep the secure version with _user_id parameter
-- This function should already exist and work properly for admin access
