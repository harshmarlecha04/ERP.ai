-- Fix table and column names in get_material_requirements_by_date_range function
-- Correct: production_schedules (not production_schedule)
-- Correct: schedule_date (not scheduled_date)
