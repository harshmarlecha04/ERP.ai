...
-- by qualifying all raw_material_id references
...
BEGIN
  ...
  LEFT JOIN inventory_summary inv ON inv.inv_raw_material_id = ms.raw_material_id
  LEFT JOIN purchase_orders_summary po ON po.po_raw_material_id = ms.raw_material_id
