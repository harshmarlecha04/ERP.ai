...
-- Fixed version handling existing functions

-- Drop existing functions first
DROP FUNCTION IF EXISTS public.get_profiles_hr_access(uuid);
DROP FUNCTION IF EXISTS public.get_user_display_info(uuid[]);
DROP FUNCTION IF EXISTS public.get_team_member_basic_info(uuid);
