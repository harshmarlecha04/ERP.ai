...
DROP FUNCTION IF EXISTS public.get_employee_sensitive_data;
...
GRANT EXECUTE ON FUNCTION public.get_employee_sensitive_data_secure TO authenticated;
GRANT EXECUTE ON FUNCTION public.update_employee_data_with_approval TO authenticated;